  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-[#00cc5c]/20 blur-3xl" />
        <div className="absolute -bottom-40 -right-20 w-[500px] h-[500px] rounded-full bg-[#5897f4]/20 blur-3xl" />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-[#00cc5c]/10 text-[#00cc5c] px-3 py-1 text-xs font-medium mb-4">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a href="#demo" className="inline-flex items-center justify-center h-11 px-6 rounded-md bg-[#00cc5c] text-white font-medium shadow-[0_15px_40px_rgba(0,204,92,0.35)] hover:brightness-95 transition">
                Book a demo
              </a>
          ...
          <motion.div
            ...
            <div className="relative bg-white rounded-2xl border border-[#2d2d2d]/10 p-4 shadow-[0_30px_80px_rgba(45,45,45,0.15)]">
              ...
              <div className="absolute -bottom-6 -right-6 w-28 h-28 rounded-xl bg-[#5897f4] shadow-[0_20px_60px_rgba(88,151,244,0.5)]" />
              <div className="absolute -top-6 -left-6 w-24 h-24 rounded-xl bg-[#00cc5c] shadow-[0_20px_60px_rgba(0,204,92,0.5)]" />
            </div>
          </motion.div>
        </div>
      </div>
