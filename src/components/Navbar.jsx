      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button className="h-9 px-4 rounded-md bg-[#00cc5c] text-white font-medium shadow-[0_10px_30px_rgba(0,204,92,0.35)] hover:brightness-95 transition glow-green">Get a demo</button>
          </div>
