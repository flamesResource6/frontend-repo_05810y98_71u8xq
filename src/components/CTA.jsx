    ...
    <section id="demo" className="py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          <a className="inline-flex items-center justify-center h-11 px-6 rounded-md bg-[#00cc5c] text-white font-medium shadow-[0_15px_40px_rgba(0,204,92,0.35)] hover:brightness-95 transition" href="#">
            Book a demo
          </a>
