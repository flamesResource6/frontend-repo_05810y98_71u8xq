...
export default function Features() {
  return (
    <section id="features" className="py-24 relative">
      ...
      <div className="absolute inset-x-0 top-0 -z-10 h-40 bg-gradient-to-r from-[#00cc5c]/20 via-transparent to-[#5897f4]/20" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-white/80">All the building blocks to scale a flexible workforce without the chaos.</p>
        </div>

        <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map(({ icon: Icon, title, desc, color }) => (
            <div key={title} className="group p-6 rounded-2xl bg-white/5 border border-white/10 shadow-[0_15px_50px_rgba(0,0,0,0.25)] hover:shadow-[0_25px_80px_rgba(0,0,0,0.45)] transition-shadow gradient-border tilt">
              <div className="flex items-center gap-3 mb-3">
                <div className="h-9 w-9 rounded-md flex items-center justify-center" style={{ backgroundColor: color + '26' }}>
